...
export const FILE_TREE: FileNode[] = [
    { name: "README.md", type: "file", path: "/code", icon: "markdown" },
    {
        name: "src",
        type: "folder",
        path: "/code",
        children: [
            {
                ...
                path: "/code",
                children: [
                    { name: "intro.py", type: "file", path: "/code/intro", icon: "python" },
                    { name: "projects.json", type: "file", path: "/code/projects", icon: "json" },
                    { name: "skills.ts", type: "file", path: "/code/skills", icon: "typescript" },
                    { name: "contact.md", type: "file", path: "/code/contact", icon: "markdown" },
                ],
            },
            {
                name: "blog",
            ...
            },
            {
                ...
                path: "/code/frontend",
                children: [
                    { name: "package.json", type: "file", path: "/code/frontend/package", icon: "json" },
                    { name: "index.html", type: "file", path: "/code/frontend/index", icon: "html" },
                    { name: "main.tsx", type: "file", path: "/code/frontend/main", icon: "typescript" },
                    { name: "App.tsx", type: "file", path: "/code/frontend/app", icon: "typescript" },
                    { name: "Home.tsx", type: "file", path: "/code/frontend/home", icon: "typescript" },
                    { name: "Projects.tsx", type: "file", path: "/code/frontend/projects-page", icon: "typescript" },
                    { name: "Skills.tsx", type: "file", path: "/code/frontend/skills-page", icon: "typescript" },
                    { name: "Contact.tsx", type: "file", path: "/code/frontend/contact-page", icon: "typescript" },
                ],
            },
        ],
    },
